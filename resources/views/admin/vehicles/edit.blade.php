<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ✏️ Edit Kendaraan: {{ $vehicle->brand }} {{ $vehicle->model }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    {{-- ✅ FIX: Tambah id="vehicleForm" --}}
                    <form action="{{ route('admin.vehicles.update', $vehicle) }}" method="POST" id="vehicleForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                {{-- ✅ FIX: Tambah fallback $vehicle->unit_code, hapus required (nullable di DB) --}}
                                ...
                                @error('unit_code')<p class="text-red-600 text-sm mt-1">{{ $message }}</p>@enderror
                            </div>
                            ...
                            <div>
                                ...
                                {{-- ✅ FIX: Tambah fallback $vehicle->plate_no --}}
                            ...
                            <div>
                                ...
                                <input type="number" name="odometer_km"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="status"
                                    ...
                                    <option value="retired"     {{ old('status', $vehicle->status) === 'retired'     ? 'selected' : '' }}>⛔ Tidak Aktif</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" rows="3"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('notes', $vehicle->notes) }}</textarea>
                            </div>
                        </div>
