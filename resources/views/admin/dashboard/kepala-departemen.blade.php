<x-app-layout>
    <x-slot name="header">Dashboard Kepala Departemen</x-slot>
            ...
            <div class="rounded-xl p-4 border transition hover:shadow-md"
                ...
                <div class="grid grid-cols-2 gap-2 mb-3">
                    ...
                    <div class="col-span-2 rounded-lg p-2.5" style="background:#fffbeb;">
                        <p class="text-xs text-amber-500 font-semibold uppercase tracking-wide">Preferensi Kendaraan</p>
                        <p class="text-sm text-gray-700 mt-0.5">
                            🚗 {{ $req->preferredVehicle->brand }} {{ $req->preferredVehicle->model }}
                            <span class="font-mono text-xs text-gray-400">({{ $req->preferredVehicle->plate_no }})</span>
                        </p>
                    </div>
                    @endif
                    @if($req->notes)
                ...
                {{-- Row 3: Action --}}
                <a href="{{ route('approvals.kepala.approve', $req) }}"
                ...
                <tbody>
                    ...
                    <tr class="group hover:bg-blue-50/30 transition-colors" style="border-bottom:1px solid #f8fafc;">
                        ...
                        <td class="px-5 py-3.5 whitespace-nowrap">
                            ...
                            @elseif($req->preferredVehicle)
                                <p class="text-xs text-gray-400 italic">
                                    Pref: {{ $req->preferredVehicle->brand }} {{ $req->preferredVehicle->model }}
                                </p>
                            @else
                        ...
                        <td class="px-5 py-3.5 whitespace-nowrap">
                            <a href="{{ route('loan-requests.show', $req) }}"
